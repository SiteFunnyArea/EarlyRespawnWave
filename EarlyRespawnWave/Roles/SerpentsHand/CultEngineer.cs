...
{
    public class CultEngineer : ICustomRole
    {
        public override string Name { get; set; } = "Serpents Hand Cult Engineer";
        public override Teams Team { get; set; } = Teams.SerpentsHand;
        public override RoleTypeId Role { get; set; } = RoleTypeId.Tutorial;
        public SHTeamPersonnel Personnel { get; set; } = SHTeamPersonnel.Engineer;
        ...
        public override string CustomInfo { get; set; } = "Serpents Hand Cult Engineer";
